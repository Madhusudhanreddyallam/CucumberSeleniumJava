...
public class Amazon_All_category {
	Tablets tablets;
	Phones phones;
	Cameras cameras;
	...
	public void i_click_on_add_to_cart_of_samsung_galaxy_tab() {
		tablets = new Tablets(BaseClass.getDriver());System.out.println("Tablets: "+Thread.currentThread().getId());
	...
	public void i_click_on_add_to_cart_of_iphone() {
		phones = new Phones(BaseClass.getDriver()); System.out.println("Phones: "+Thread.currentThread().getId());
	...
	public void i_click_on_add_to_cart_of_nikon() {
		cameras = new Cameras(BaseClass.getDriver()); System.out.println("Cameras: "+Thread.currentThread().getId());
